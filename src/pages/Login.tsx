...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex antialiased text-white">
      ...
      {/* ── Right: Form panel ── */}
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        {/* Subtle blobs */}
        ...
        <div className="relative w-full max-w-[380px]">
          ...
          <div className="a4 text-center">
            <p className="text-sm text-white/70">
              ...
              <Link to="/register" className="text-white font-bold hover:text-blue-200 transition-colors">
                Create one now
              </Link>
            </p>
          </div>
