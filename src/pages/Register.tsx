        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-black leading-tight mb-4">
              Begin Your<br/>
              <span className="gt">Counseling</span><br/>
              <span className="gt">Journey</span>
            </h1>
            ...
            <div className="mt-8 space-y-3">
              {[
                ...
                {n:'2', t:'Visit the Guidance Office for your Student ID'},
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 relative overflow-y-auto">
        ...
        <div className="relative w-full max-w-[380px] py-8">
          ...
          <div className="mb-7 a0">
            <h2 className="text-[28px] font-black text-white mb-1.5">Create account</h2>
            <p className="text-gray-500 text-[14px]">Register with your personal email address</p>
          </div>
          ...
          {success ? (
            ...
            <>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                {/* Full Name */}
                <div className="a1">
                  <label className="block text-[13px] font-semibold text-gray-400 mb-2">Full Name</label>
                  <div className="relative">
                ...
                {/* Email */}
                <div className="a2">
                  <label className="block text-[13px] font-semibold text-gray-400 mb-2">Personal Email</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                      <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Password */}
                <div className="a3">
                  <label className="block text-[13px] font-semibold text-gray-400 mb-2">Password</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                      <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Confirm Password */}
                <div className="a4">
                  <label className="block text-[13px] font-semibold text-gray-400 mb-2">Confirm Password</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                      <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              ...
              <div className="a6 text-center mt-5 pt-5 border-t border-white/[0.06]">
